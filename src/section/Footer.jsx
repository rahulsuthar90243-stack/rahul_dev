...
function Footer() {
  return (
   <footer id="footer" className='relative overflow-hidden bg-[#000611] '>
    ...
    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_30%_70%,rgba(16,185,202,0.35),transparent_70%)]"/>
