	...
	return (
		<section className={`github-card ${className}`} aria-labelledby="github-title">
			<div className="github-heading">
				<span className="github-icon" aria-hidden="true"><FaGithub /></span>
...
const styles = `
	...
	.github-heading { display:flex; align-items:center; gap:10px; min-height:28px; }.github-heading h2 { margin:0; font:700 22px/1.2 inherit; letter-spacing:-.03em; background:linear-gradient(90deg,#25d9fa,#8a62ff); -webkit-background-clip:text; background-clip:text; color:transparent; }.github-icon { display:grid; place-items:center; width:25px; height:25px; color:#32d5fb; font-size:21px; }.github-loading { width:52px; height:3px; margin-left:auto; overflow:hidden; border-radius:99px; background:#30343c; }.github-loading::after { content:""; display:block; width:42%; height:100%; background:#58d9ff; animation:github-load 1s ease-in-out infinite; }
